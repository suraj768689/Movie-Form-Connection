...
const MovieForm = () => {
    ...
    const [cast, setCast] = useState([{ starName: '', starImage: '', starRole: '' }]);
    ...
    const handleCastChange = (index, field, value) => {
      const newCast = [...cast]; // Clone the existing cast array
      newCast[index] = { ...newCast[index], [field]: value }; // Modify the specific cast member
      setCast(newCast); // Update the state with the updated cast array
    };
