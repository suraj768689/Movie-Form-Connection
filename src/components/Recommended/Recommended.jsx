...
const Recommended = (props) => {
  ...
  const openMovie = (movieId) => {
    navigate(`/view-movie/${movieId}`, {
      state: { isRole: isRole, isLoggedIn: props.isLoggedIn, token: bigtoken },
    });
  };
      ...
      <div className="flex-fill">
        ...
        {rmovie.length <= 0 ? (
          <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
            <img src="/loading.gif" style={{ height: "auto", width: "200px" }} alt="" />
          </div>
        ) : (
          <div>
            <div className="scroll-buttons">
              <button className="scroll-button left" onClick={scrollLeft}>
                <img src={"icons8-arrow-50.png"} alt=""></img>
              </button>
            </div>
                      ...
                      <div className="card-body" style={{ backgroundColor: "black" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "space-evenly" }}>
                          ...
                          <div className="col-sm-4" style={{ padding: "0.3rem" }}>
                            <span>
                              {rmovie.rating !== null ? rmovie.rating : "NA"}
